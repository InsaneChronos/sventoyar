...
document.getElementById("nuts").addEventListener("mouseover", function() {
	...
	document.getElementById("squirrel").style.background = "url(https://insanechronos.github.io/sventoyar/assets/img/squirrel.png) left center no-repeat";
...
function openNav() {
	...
	document.getElementById("burger").style.background = "url(https://insanechronos.github.io/sventoyar/assets/svg/burger-3.svg) center no-repeat";
	...
	if (actualMargin == "0px") {
		...
		document.getElementById("burger").style.background = "url(https://insanechronos.github.io/sventoyar/assets/svg/burger-2.svg) center no-repeat";
		document.getElementById("burger").style.backgroundSize = "cover";
		...
		document.getElementById("burger").addEventListener("mouseout", function() {
			document.getElementById("burger").style.background = "url(https://insanechronos.github.io/sventoyar/assets/svg/burger-1.svg) center no-repeat";
			document.getElementById("burger").style.backgroundSize = "cover";
			}
			);
...
if (window.innerHeight > window.innerWidth || window.innerWidth < 520){
	...
	document.getElementById("nuts").addEventListener("mouseover", function() {
		document.getElementById("squirrel").style.display = "block";
		document.getElementById("squirrel").style.background = "url(https://insanechronos.github.io/sventoyar/assets/img/squirrel-m.png) left center no-repeat";
		document.getElementById("squirrel").style.backgroundSize = "auto";
